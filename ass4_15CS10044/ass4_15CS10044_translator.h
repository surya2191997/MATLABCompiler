...
class symbol_table_fields{													
	...
	symbol_table_fields(char * = 0 , type_ds * = 0, void * = 0, int = -1, int = -1, symbolTable * = 0);	
	~symbol_table_fields();
};
