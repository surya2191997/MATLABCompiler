...
%type<initializer> initializer-row-list;
%type<initializer> initializer-row;
...
direct-declarator  :  IDENTIFIER                                         
				   ...
				   |  direct-declarator '[' assignment-expression ']' '[' assignment-expression ']'   
				   {
				   		if(flag1 == 0 || flag2 == 0){
					  		...
					  		$$.type = temp;
					  		$$.width = $1.width * $3.val.int_data * $6.val.int_data;
					  		$$.var = $1.var;
					  	}
				   }
