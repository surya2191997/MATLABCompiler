...
symbol_table_fields::symbol_table_fields(char *name_init, type_ds *Type_init, void *initial_value_init, int size_init, int offset_init, symbolTable *nestedTable_init, char* scope_init) :  nestedTable(nestedTable_init), name(name_init), scope(scope_init), Type(Type_init), initial_value(initial_value_init), size(size_init), offset(offset_init) {}
...
void print_Initial_Value(void *temp, type_ds *t){
	...
	if(temp == NULL)
		...
		vector<int>* v = static_cast<vector<int>*>(temp );
...
symbol_table_fields *symbolTable::gentemp(type_ds* temp){
	...
	symbol_table_fields y(s,t,0,temp_size,-1,0,str);
	this->insert(y);
...
quad_fields::quad_fields(char *arg1_f, char *arg2_f, char *res_f, quad_instr_types op_f) : labelIdx(0), res(res_f), op(op_f), arg1(arg1_f), arg2(arg2_f) {}
...
void quad_fields::print_quad_fields(int line){
	...
	if(this->arg2){
			...
			else if(this->op == Function)  printf("\n%3d : %s : \n",line,arg1);

			else if(this->op == Function_END) printf("%3d : end %s \n\n",line,arg1);
